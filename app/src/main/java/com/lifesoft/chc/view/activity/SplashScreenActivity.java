...
public class SplashScreenActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Circular
        configSplash.setBackgroundColor(R.color.key_color); //any color you want form colors.xml
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.android_logo); //or any other drawable
